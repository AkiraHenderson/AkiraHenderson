...
<div align="center">
  <h2>🎮 About Me</h2>
  <p>
    <b>🎙️ Virtual Creator:</b> 가상 공간에서 다채로운 페르소나를 통해 소통하고 콘텐츠를 창작합니다.<br/>
    <b>🔭 Project:</b> 내러티브 중심 횡스크롤 액션 RPG <b>『THE SHADOWS』</b> 프리 프로덕션 진행.<br/>
    <b>🖋️ Design:</b> 게임 디자인 문서, 시스템 플로우 차트 설계 및 세계관 구축.<br/>
    <b>🦉 Workflow:</b> 주로 고요한 새벽 시간대에 작업 효율이 극대화되는 올빼미형.<br/>
    <b>📐 Logic:</b> 게임 아키텍처와 로직 설계를 위해 기반을 다지는 중입니다.
  </p>
</div>
